...
export const MOCK_WALLET: Wallet = {
  ...
  recentTransactions: [
    { id: "txn_001", type: "TOP_UP",    amount: 180,   timestamp: "2026-05-04T19:30:00Z", method: "INSTANT_EFT",  status: "SUCCESS" },
    { id: "txn_002", type: "BET_PLACED",amount: -25,   timestamp: "2026-05-04T20:10:00Z", description: "Kaizer Chiefs vs Orlando Pirates — Both to score", status: "SETTLED" },
    { id: "txn_003", type: "WINNINGS",  amount: 62.5,  timestamp: "2026-05-04T22:05:00Z", description: "Kaizer Chiefs payout", status: "CREDITED" },
    { id: "txn_004", type: "TOP_UP",    amount: 100,   timestamp: "2026-04-27T17:00:00Z", method: "INSTANT_EFT",  status: "SUCCESS" },
    { id: "txn_005", type: "BET_PLACED",amount: -50,   timestamp: "2026-04-27T18:30:00Z", description: "UFC 313 — Poirier to win", status: "SETTLED" },
    { id: "txn_006", type: "TOP_UP",    amount: 50,    timestamp: "2026-04-20T19:55:00Z", method: "SAVED_CARD",   status: "SUCCESS" },
    { id: "txn_007", type: "TOP_UP",    amount: 180,   timestamp: "2026-04-13T11:00:00Z", method: "INSTANT_EFT",  status: "SUCCESS" },
    { id: "txn_008", type: "BET_PLACED",amount: -30,   timestamp: "2026-04-13T12:00:00Z", description: "NBA Playoffs — Celtics ML", status: "SETTLED" },
    { id: "txn_009", type: "WINNINGS",  amount: 57,    timestamp: "2026-04-13T14:00:00Z", description: "NBA Playoffs payout", status: "CREDITED" },
    { id: "txn_010", type: "TOP_UP",    amount: 100,   timestamp: "2026-04-06T09:00:00Z", method: "INSTANT_EFT",  status: "SUCCESS" },
  ],
